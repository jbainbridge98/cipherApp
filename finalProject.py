...
def decryptVigenere(ciphertext, key):
    ...
    generatedCipherText = tempPlainText
...
def main():
    ...
    print("When entering inputs please enter in capitol letters and only input phrases with letters and spaces (some ciphers may not accept spaces)")
    userResponse = input(
        "Enter 'encrypt' to encrypt a text or 'decrypt' to decrypt a text. Enter 'q' to exit the program: ")
    print("")
    while (userResponse != "q"):
        if userResponse == "encrypt":
            ...
            while (value):
                ...
                while ((userCipher < 1 or userCipher > 8) and flag == 0):
                    userCipher = input("Please enter the corresponding number: ")
                    userCipher = int(userCipher)
                if flag == 0:
                    if option != 'y' and option != 'Y':
                        userPlainText = input("Please enter the plaintext that you want to encrypt (No spaces for Monoalphabetic or Transposition, No j's for Playfair, and no repeating letters for the Playfair key): ")
                    else:
                        print("Your encrypted text for previous level is", generatedCipherText)
                        print("Your key for previous level is", generatedKey)
                        print(
                            "Keep note of all encrypted texts and keys as you will have to enter them in reverse order to decrypt")
                ...
                if userCipher == 1:
                    ...
                    output.append(3)
                    output.append(encryptCaesar(userPlainText))
                    ...
                    # portaencrypt
                    portaKey = input("Enter Key(must be letters): ")
                    ...
                    encryptPlayfair(userPlainText, key)
            ...
            while (not isinstance(userCipher, int)):
                ...
                try:
                    ...
                    print("Please enter an integer!")
            while (userCipher < 1 or userCipher > 8):
                userCipher = input("Please enter the corresponding number: ")
                userCipher = int(userCipher)
            userCipherText = input("Please enter the ciphertext that you want to decrypt (No repeating letters for Playfair): ")
            userKey = input("Please enter the key that was used to encrypt the ciphertext: ")
            if userCipher == 1:
                decryptVigenere(userCipherText, userKey)
                print("The plaintext generated is ", generatedCipherText)
            elif userCipher == 2:
                try:
                    userKey = int(userKey)
                except ValueError:
                ...
                encryptPorta(userKey, userCipherText)
                print("The plaintext generated is ", generatedCipherText)
            elif userCipher == 7:
